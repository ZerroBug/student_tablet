<nav class="sidebar d-none d-md-flex flex-column" style='z-index:2000'>
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end border-0 shadow-sm ms-3" aria-labelledby="tabletDropdown">
            ...
            <li><a class="dropdown-item text-primary" href="#"><i class="fa fa-undo me-2"></i> Return Tablet</a></li>
    ...
    <a href="reports.php"><i class="fa fa-chart-bar me-2 mx-2"></i> Reports</a>
    <a href="settings.php"><i class="fa fa-cog me-2 mx-2"></i> Settings</a>
</nav>